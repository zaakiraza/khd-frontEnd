  ...
  return (
    <div className="formDiv">
      ...
      <form onSubmit={handleSubmit}>
            ...
            <div className="left_align">
              ...
              <div className="formGroup">
                ...
                <input
                  ...
                  className={`formInput ${errors.first_name ? "invalid" : ""}`}
                  onChange={(e) => {
              ...
              <div className="formGroup">
                ...
                <input
                  ...
                  className={`formInput ${errors.father_name ? "invalid" : ""}`}
                  onChange={(e) => {
            ...
            <div className="right_align">
              ...
              <div className="formGroup">
                ...
                >
                  ...
                  <option value="Ayatullah Khamenei">Ayatullah Khamenei</option>
        ...
        {/* Academic Info */}
        <div className={togglesecond == "▾" ? "academic_progress" : "onClose"}>
          <div
            className="toggleBox"
          ...
          <div className="two_side_form">
            <div className="left_align">
              {/* ACADEMIC CLASS */}
              <div className="formGroup">
                <label className="formLabel">Enter Your Academic Class*</label>
                <input
                  type="text"
              ...
              {/* institute_name */}
              <div className="formGroup">
                <label className="formLabel">Enter Your Institute Name*</label>
                <input
                  type="text"
            ...
            <div className="right_align">
              ...
              <div className="formGroup">
                ...
                <div
                  style={{ display: "flex", gap: "16px", padding: "11px 4px" }}
        ...
        <div className={togglefourth == "▾" ? "guardian_info" : "onClose"}>
          ...
          <div className="two_side_form">
            <div className="left_align">
              ...
              {/* email */}
              <div className="formGroup">
                <label className="formLabel">Enter Your Guardian Email*</label>
                <input
                  type="email"
